    ...
    <div id="site_content">
     <div class="sidebar">
      ...
      <div id="content">
        ...
        <button name="gen" type="submit" class="button" >Generate Heat Chart</button>
        </form>
        ...
        ?>
        <center><b>*For further inforation check <u style="color:blue;">data.xlsx</u> in <u style="color:skyblue;">\data\IP\</u> folder.

      </div>
    </div>
   
  </div>
<script src="Script/rajamchawal.js"></script>
</body>
</html>
...
if(isset($_POST['gen']))
{
  execInBackground('start cmd.exe @cmd /k "python python/IPAgg.py"'); 
  echo "
  <script>
  window.location.href = 'Heat.php';
  </script>
