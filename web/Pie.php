...
<body>
    ...
    <div id="site_content">
     <div class="sidebar">
      ...
      <div id="content">
        ...
        <button name="gen" type="submit" class="button" >Generate Pie Chart</button>
        </form>
 ...
 <script src="Script/pavbhaji.js"></script>
</body>
</html>
...
if(isset($_POST['gen']))
{
  execInBackground('start cmd.exe @cmd /k "python python/genpie.py"'); 
  echo "
  <script>
  window.location.href = 'Pie.php';
  </script>
