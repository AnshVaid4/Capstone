...
def aggrIP(data,tod=False):
  ...
  if(tod==False):plt.savefig(f"{parent}\data\\heat\\Comments.png")
  else:plt.savefig(f"{parent}\data\\heat\\Comments_today.png")
  plt.clf()
  ...
  if(tod==False):plt.savefig(f"{parent}\data\\heat\\Flags.png")
  else:plt.savefig(f"{parent}\data\\heat\\Flags_today.png")
  plt.clf()
  ...
  if(tod==False):plt.savefig(f"{parent}\data\\heat\\Time.png")
  else:plt.savefig(f"{parent}\data\\heat\\Time_today.png")
  plt.clf()
  ...
  if(tod==False):plt.savefig(f"{parent}\data\\heat\\Date.png")
  plt.clf()
